...
export const REPORT_CATALOG: CatalogEntry[] = [
  ...
  { type: "15", title: "Problem Cost by Accountable Party", category: "Cost & Multi-well", params: ["wells", "dateRange"], exports: ["pdf", "xlsx"], available: true, blurb: "Problem cost pivoted on who it is charged to, stacked by problem kind." },
